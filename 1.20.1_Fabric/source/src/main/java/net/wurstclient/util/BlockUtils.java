...
public enum BlockUtils
{
	...
	private static final ThreadLocal<BlockPos.Mutable> MUTABLE_POS_FOR_EXPOSED_CHECK =
	...
	{
		BlockPos.Mutable mutablePos = MUTABLE_POS_FOR_EXPOSED_CHECK.get();
		for(Direction direction : Direction.values())
			if(!isOpaqueFullCube(mutablePos.set(pos, direction)))
				return true;
